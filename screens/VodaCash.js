        ...
        <View>
            <View style={{ height: '100%', width: windowWidth, paddingTop: StatusBarHeight, backgroundColor: "#fff", paddingHorizontal: 20 }}>
                ...
                <View style={{ marginTop: 10, height: 200 }}>
                    <TitleText style={{ color: '#000', fontSize: 25, marginBottom: 15 }}>Vodafone Cash</TitleText>
                    <RegularTexts style={{ color: '#6A6A6A', marginBottom: 35 }}>Pay for your trips using Voda Cash. Enter a valid vodafone cash number to get started</RegularTexts>


                    <RegularTexts style={{ marginBottom: 8, fontSize: 15, fontFamily: 'Manrope_600SemiBold' }}>Vodafone Cash Number</RegularTexts>
                    <StyledInput
                        icon="phone-outline"
